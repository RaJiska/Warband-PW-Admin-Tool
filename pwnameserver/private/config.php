...
class pw_name_server_config
{
  ...
  const database_username = "yolo";
  const database_password = "yolo";
  const database_name = "yolo";
  const max_names_per_player = 5;
  const admin_permissions_first_field_no = 3;
  const punishments_manager_first_field_no = 4;
  ...
  const not_registered_error = 4;
	...
	const pm_identifier = 1;
	const ns_identifier = 2;
