...
scripts.extend([
  ...
  ("setup_player_joined", # server: when a player connects, update necessary data on clients, restore data from previous play sessions in this mission, and set up other attributes
   [(store_script_param, ":player_id", 1), # must be valid
	...
	(str_store_string, s13, "str_name_server"),
	(str_store_string, s14, "str_name_server_password"),
	(str_store_string, s10, "str_ban_check_url"),
	(server_add_message_to_log, "@{s10}"),
...
scripts.extend([
  ...
  ("cf_admin_action", # server: check player requests to use admin tools, applying if successful
   [(store_script_param, ":admin_action", 1), # constants starting with admin_action_
	...
	########## Ra'Jiska ##########
	(player_get_unique_id, reg10, ":admin_player_id"),
	(player_get_unique_id, reg11, ":target_player_id"),
	(str_store_player_username, s10, ":admin_player_id"),
	(str_store_player_username, s11, ":target_player_id"),
	########## -------- ##########
	
    (player_is_admin, ":admin_player_id"),
    (try_begin), # this tool and ones past it are applied to the admin themself
      (is_between, ":admin_action", admin_action_teleport_forwards, admin_action_lock_faction),
    ...
    (try_begin),
	  ...
	  (str_store_string, s12, "str_action_temp_kick"),
	  (str_store_string, s15, "str_ban_player_url"),
	  (send_message_to_url, s15),
	  (server_add_message_to_log, s15),
	  (kick_player, ":target_player_id"), # Kick - Kick
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_1h),
	  #(player_slot_eq, ":admin_player_id", slot_player_admin_temp_ban_1h, 0),
	  (player_slot_eq, ":admin_player_id", slot_player_admin_no_temporary_ban, 0),
	  (str_store_string, s12, "str_action_temp_1h"),
	  (str_store_string, s15, "str_ban_player_url"),
	  (send_message_to_url, s15),
	  (multiplayer_send_string_to_player,":target_player_id", server_event_local_chat, "@You have been banned from the server by {s10} for 1 hour."),
	  (kick_player, ":target_player_id"), # Kick - 1h
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_3h),
	  #(player_slot_eq, ":admin_player_id", slot_player_admin_temp_ban_3h, 0),
	  (player_slot_eq, ":admin_player_id", slot_player_admin_no_temporary_ban, 0),
	  (str_store_string, s12, "str_action_temp_3h"),
	  (str_store_string, s15, "str_ban_player_url"),
	  (send_message_to_url, s15),
	  (multiplayer_send_string_to_player,":target_player_id", server_event_local_chat, "@You have been banned from the server by {s10} for 3 hours."),
	  (kick_player, ":target_player_id"), # Kick - 3h
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_12h),
	  #(player_slot_eq, ":admin_player_id", slot_player_admin_temp_ban_12h, 0),
	  (player_slot_eq, ":admin_player_id", slot_player_admin_no_temporary_ban, 0),
	  (str_store_string, s12, "str_action_temp_12h"),
	  (str_store_string, s15, "str_ban_player_url"),
	  (send_message_to_url, s15),
	  (multiplayer_send_string_to_player,":target_player_id", server_event_local_chat, "@You have been banned from the server by {s10} for 12 hours."),
	  (kick_player, ":target_player_id"), # Kick - 12h
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_1d),
	  #(player_slot_eq, ":admin_player_id", slot_player_admin_temp_ban_1d, 0),
	  (player_slot_eq, ":admin_player_id", slot_player_admin_no_temporary_ban, 0),
	  (str_store_string, s12, "str_action_temp_1d"),
	  (str_store_string, s15, "str_ban_player_url"),
	  (server_add_message_to_log, "@{s15}"),
	  (send_message_to_url, s15),
	  (multiplayer_send_string_to_player,":target_player_id", server_event_local_chat, "@You have been banned from the server by {s10} for 1 day."),
	  (kick_player, ":target_player_id"), # Kick - 1d
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_3d),
	  #(player_slot_eq, ":admin_player_id", slot_player_admin_temp_ban_3d, 0),
	  (player_slot_eq, ":admin_player_id", slot_player_admin_no_temporary_ban, 0),
	  (str_store_string, s12, "str_action_temp_3d"),
	  (str_store_string, s15, "str_ban_player_url"),
	  (send_message_to_url, s15),
	  (multiplayer_send_string_to_player,":target_player_id", server_event_local_chat, "@You have been banned from the server by {s10} for 3 days."),
	  (kick_player, ":target_player_id"), # Kick - 3d
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_1w),
	  #(player_slot_eq, ":admin_player_id", slot_player_admin_temp_ban_1w, 0),
	  (player_slot_eq, ":admin_player_id", slot_player_admin_no_temporary_ban, 0),
	  (str_store_string, s12, "str_action_temp_1w"),
	  (str_store_string, s15, "str_ban_player_url"),
	  (send_message_to_url, s15),
	  (multiplayer_send_string_to_player,":target_player_id", server_event_local_chat, "@You have been banned from the server by {s10} for 1 week."),
	  (kick_player, ":target_player_id"), # Kick - 1w
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_2w),
	  #(player_slot_eq, ":admin_player_id", slot_player_admin_temp_ban_2w, 0),
	  (player_slot_eq, ":admin_player_id", slot_player_admin_no_temporary_ban, 0),
	  (str_store_string, s12, "str_action_temp_2w"),
	  (str_store_string, s15, "str_ban_player_url"),
	  (send_message_to_url, s15),
	  (multiplayer_send_string_to_player,":target_player_id", server_event_local_chat, "@You have been banned from the server by {s10} for 2 weeks."),
	  (kick_player, ":target_player_id"), # Kick - 2w
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_3w),
	  #(player_slot_eq, ":admin_player_id", slot_player_admin_temp_ban_3w, 0),
	  (player_slot_eq, ":admin_player_id", slot_player_admin_no_temporary_ban, 0),
	  (str_store_string, s12, "str_action_temp_3w"),
	  (str_store_string, s15, "str_ban_player_url"),
	  (send_message_to_url, s15),
	  (multiplayer_send_string_to_player,":target_player_id", server_event_local_chat, "@You have been banned from the server by {s10} for 3 weeks."),
	  (kick_player, ":target_player_id"), # Kick - 3w
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_1m),
	  #(player_slot_eq, ":admin_player_id", slot_player_admin_temp_ban_1m, 0),
	  (player_slot_eq, ":admin_player_id", slot_player_admin_no_temporary_ban, 0),
	  (str_store_string, s12, "str_action_temp_1m"),
	  (str_store_string, s15, "str_ban_player_url"),
	  (send_message_to_url, s15),
	  (multiplayer_send_string_to_player,":target_player_id", server_event_local_chat, "@You have been banned from the server by {s10} for 1 month."),
	  (kick_player, ":target_player_id"), # Kick - 1m
  (else_try),
	  (eq, ":admin_action", admin_action_ban_player_perm),
	  (player_slot_eq, ":admin_player_id", slot_player_admin_no_permanent_ban, 0),
	  (str_store_string, s12, "str_action_temp_perm"),
	  (str_store_string, s15, "str_ban_player_url"),
	  (send_message_to_url, s15),
	  (multiplayer_send_string_to_player,":target_player_id", server_event_local_chat, "@You have been permanently banned from the server by {s10}."),
	  (kick_player, ":target_player_id"), # Kick - perm
	(else_try),
    ...
    (else_try),
      ...
      (try_begin),
		...
		(str_store_string, s12, "str_action_temp_slay"),
	    (str_store_string, s15, "str_ban_player_url"),
	    (send_message_to_url, s15),
      (else_try),
    ...
    (str_store_player_username, s2, ":admin_player_id"),
    (try_begin),
	...
	(try_begin),
	  ...
	  (str_store_player_username, s1, ":target_player_id"),
	  (player_get_unique_id, reg1, ":target_player_id"),
	  (server_add_message_to_log, "@Admin {s2} ({reg0}) temporarily banned player {s1} ({reg1}) for '1 hour'."),
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_3h),
	  (str_store_player_username, s1, ":target_player_id"),
	  (player_get_unique_id, reg1, ":target_player_id"),
	  (server_add_message_to_log, "@Admin {s2} ({reg0}) temporarily banned player {s1} ({reg1}) for '3 hours'."),
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_12h),
	  (str_store_player_username, s1, ":target_player_id"),
	  (player_get_unique_id, reg1, ":target_player_id"),
	  (server_add_message_to_log, "@Admin {s2} ({reg0}) temporarily banned player {s1} ({reg1}) for '12 hours'."),
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_1d),
	  (str_store_player_username, s1, ":target_player_id"),
	  (player_get_unique_id, reg1, ":target_player_id"),
	  (server_add_message_to_log, "@Admin {s2} ({reg0}) temporarily banned player {s1} ({reg1}) for '1 day'."),
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_3d),
	  (str_store_player_username, s1, ":target_player_id"),
	  (player_get_unique_id, reg1, ":target_player_id"),
	  (server_add_message_to_log, "@Admin {s2} ({reg0}) temporarily banned player {s1} ({reg1}) for '3 days'."),
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_1w),
	  (str_store_player_username, s1, ":target_player_id"),
	  (player_get_unique_id, reg1, ":target_player_id"),
	  (server_add_message_to_log, "@Admin {s2} ({reg0}) temporarily banned player {s1} ({reg1}) for '1 week'."),
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_2w),
	  (str_store_player_username, s1, ":target_player_id"),
	  (player_get_unique_id, reg1, ":target_player_id"),
	  (server_add_message_to_log, "@Admin {s2} ({reg0}) temporarily banned player {s1} ({reg1}) for '2 weeks'."),
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_3w),
	  (str_store_player_username, s1, ":target_player_id"),
	  (player_get_unique_id, reg1, ":target_player_id"),
	  (server_add_message_to_log, "@Admin {s2} ({reg0}) temporarily banned player {s1} ({reg1}) for '3 weeks'."),
	(else_try),
	  (eq, ":admin_action", admin_action_temp_ban_1m),
	  (str_store_player_username, s1, ":target_player_id"),
	  (player_get_unique_id, reg1, ":target_player_id"),
	  (server_add_message_to_log, "@Admin {s2} ({reg0}) temporarily banned player {s1} ({reg1}) for '1 month'."),
    (else_try),
