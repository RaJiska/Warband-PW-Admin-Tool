...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  ("name_server_password", "yolo"),
  ("ban_check_url", "http://{s13}/server-requests/check-ban.php?uid={reg0}&id={reg1}&name={s11}&pwd={s14}"),
  ("ban_player_url", "http://{s13}/server-requests/ban-player.php?puid={reg11}&pname={s11}&aname={s10}&auid={reg10}&bantype={s12}&pwd={s14}"),
  ("admin_temp_1h", "Ban for 1 Hour"),
  ("admin_temp_3h", "Ban for 3 Hours"),
  ("admin_temp_12h", "Ban for 12 Hours"),
  ("admin_temp_1d", "Ban for 1 Day"),
  ("admin_temp_3d", "Ban for 3 Days"),
  ("admin_temp_1w", "Ban for 1 Week"),
  ("admin_temp_2w", "Ban for 2 Weeks"),
  ("admin_temp_3w", "Ban for 3 Weeks"),
  ("admin_temp_1m", "Ban for 1 Month"),
  ("action_temp_kick", "kick"),
  ("action_temp_slay", "slay"),
  ("action_temp_1h", "1h"),
  ("action_temp_3h", "3h"),
  ("action_temp_12h", "12h"),
  ("action_temp_1d", "1d"),
